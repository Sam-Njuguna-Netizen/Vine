...
export default function AboutVinePage() {
  ...
  useEffect(() => {
    const fetchPage = async () => {
      try {
        ...
        const res = await axios.get(`${API_BASE}/api/pages/about-vine`);
        setPage(res.data);
        setLoading(false);
      } catch (err) {
        console.error('Error fetching About Vine page:', err);
      ...
      <div className="bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 pt-32 pb-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center text-white mb-8">
            {/* Title changed from page.title to 'About Us' */}
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              <div className="bg-purple-50 rounded-lg p-6 border border-purple-100">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                  Want to know more about Vine LMS?
                </h3>
                <p className="text-gray-600 mb-4">
                  If you have any questions about our story, mission, or platform, our team is happy to help.
                </p>
                <Link
                  href="/contact"
