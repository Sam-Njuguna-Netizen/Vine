  ...
  useEffect(() => {
    const fetchPage = async () => {
      try {
        ...
        const res = await axios.get(`${API_BASE}/api/pages/user-agreement`);
        setPage(res.data);
        setLoading(false);
      } catch (err) {
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              <div className="bg-purple-50 rounded-lg p-6 border border-purple-100">
                ...
                <p className="text-gray-600 mb-4">
                  If you have any questions or concerns about this User Agreement, please do not hesitate to contact us.
                </p>
                <Link 
                  href="/contact"
