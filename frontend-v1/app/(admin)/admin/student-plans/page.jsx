...
export default function StudentPricingPlans() {
    ...
    const handleSavePlan = async () => {
        ...
        try {
            let response;
            if (editingPlan) {
                response = await axios.put(`/api/institutePlan/${editingPlan.id}`, planData);
            } else {
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                <h1 className="text-2xl font-bold tracking-tight">Student Pricing Plans</h1>
            ...
            <Dialog open={openPlanModal} onOpenChange={setOpenPlanModal}>
                <DialogContent className="sm:max-w-[500px]">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {editingPlan ? "Update plan details." : "Create a new pricing plan for students."}
                        </DialogDescription>
                    </DialogHeader>
